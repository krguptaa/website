...
function rara_business_footer_bottom(){ ?>
    <div class="footer-b">      
        <?php
            ...
            echo '<span class="by"><a href="' . esc_url( 'https://raratheme.com/wordpress-themes/software-company' ) .'" rel="author" target="_blank">' . esc_html__( 'Software Company', 'software-company' ) . '</a>' . esc_html__( ' by Rara Theme.', 'software-company' ) . '</span>';
