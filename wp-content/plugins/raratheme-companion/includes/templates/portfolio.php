...
<div class="portfolio-holder">	
    <?php 
    $args = apply_filters( 'rrtc_taxonomy_args', array(
    ...
    if( $terms ){ ?>
        <div class="portfolio-sorting">        
            <button data-sort-value="*" class="button is-checked"><?php echo esc_html_e( 'All', 'raratheme-companion' ); ?></button><!-- This is HACK for reducing space between inline block elements.
            --><?php
                foreach( $terms as $t ){                            
    ...
    $arg = apply_filters( 'rrtc_portfolio_args', array( 'post_type' => 'rara-portfolio', 'post_status' => 'publish', 'posts_per_page' => -1 ) );
